...
import smoky from "../assets/images/smoky.png"
...
const WeatherApp = () => {
    ...
    const api_key = '31e8758505e04a4050adf764ac2c47ec'
    ...
    const backgroundImages = {
        ...
        Smoke: 'linear-gradient(to right, #d3d3d3, #949494)', 
        Clouds: 'linear-gradient(to right, #57d6d4, #71eeec)',
        Rain: 'linear-gradient(to right, #5bc8fb, #80eaff)',
        Snow: 'linear-gradient(to right, #aff2f, #fff);',
                ...
                <>
                    ...
                    <div className="weather-data">
                        ...
                        <div className="wind">
                            ...
                            <div className="data">{data.wind ? data.wind.speed : null} mph</div></div>
                    </div>
            </>
            )}
